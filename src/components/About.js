...
const About = () => {
   return (
    <div className="border-orange-600 bg-orange-400  text-center rounded-lg w-[800px] h-[550px] overflow-x-hidden justify-center items-center mx-auto mt-11 mb-11 p-10 sm:flex-1 sm:flex-wrap">
