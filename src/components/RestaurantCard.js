...
export const RestaurantCard = ({
    ...
    return (
      <div className="grid grid-flow-row p-2 my-5 ml-11  rounded shadow-lg shadow-gray-200 bg-white dark:bg-gray-800 duration-300 hover:scale-110 overflow-x-hidden">
  ...
  // "grid grid-flow-row p-2 my-5 ml-11  rounded shadow-lg shadow-gray-200 bg-white dark:bg-gray-800 duration-300 hover:scale-110"
